...
void print_map(Map* map){
	for (int i = 0; i < map -> size; i++){
		for (int j = 0; j < map -> size; j++){
			if (get_map_value (map, i, j) == 1){
				printf("\033[1;40m 1 \033[0m");
			}
			if (get_map_value (map, i, j) == 2){
				printf("\033[1;40m 2 \033[0m");
			}
			if (get_map_value (map, i, j) == 3){
				printf("\033[1;41m 3 \033[0m");
			}
			if (get_map_value (map, i, j) == 4){
				printf("\033[1;42m 4 \033[0m");
			}
			if (get_map_value (map, i, j) == 5){
				printf("\033[1;44m 5 \033[0m");
			}
			if (get_map_value (map, i, j) == 6){
				printf("\033[1;43m 6 \033[0m");
			}
			if (get_map_value (map, i, j) == 7){
				printf("\033[1;45m 7 \033[0m");
			}
			if (get_map_value (map, i, j) == 8){
				printf("\033[1;46m 8 \033[0m");
			}
			if (get_map_value (map, i, j) == 9){
				printf("\033[1;47m 9 \033[0m");
			}
		}
		printf("\n");
	}
...
printf("Le joueur %i a gagné!!!!!", game_finished(&map));
}